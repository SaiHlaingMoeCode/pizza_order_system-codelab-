  ...
  Route::middleware(['admin_auth'])->group(function(){
    ...
    Route::prefix('product')->group(function(){
      ...
      Route::prefix('user')->group(function(){
        ...
        Route::get('change/role',[UserController::class,'userChangeRole'])->name('user#userChangeRole');
        Route::get('delete/{id}',[UserController::class,'userDelete'])->name('user#userDelete');
    });

      //contact lists
      Route::prefix('contact')->group(function(){
        Route::get('list',[UserController::class,'contactList'])->name('user#contactList');
        Route::get('delete/{id}',[UserController::class,'contactDelete'])->name('user#contactDelete');
    });
  });
