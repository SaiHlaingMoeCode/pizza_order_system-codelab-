            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0" id="dataTable">
                    ...
                    <tbody class="align-middle">
                       ...
                       <tr>
                        {{-- <input type="hidden" id="pizza_price" value="{{$c->pizza_price}}"> --}}
                        ...
                        <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                <div class="input-group-btn">
                                    <button class="btn btn-sm btn-warning text-dark btn-minus" >
                                    <i class="fa fa-minus"></i>
                                    </button>
                                </div>
                                <input type="text" disabled class="form-control form-control-sm bg-white border-0 text-center" id="qty" value="{{$c->qty}}">
                                <div class="input-group-btn">
                                    <button class="btn btn-sm btn-warning text-dark btn-plus">
